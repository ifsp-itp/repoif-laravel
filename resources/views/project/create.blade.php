...
<head>
    ...
    <link rel="icon" href="{{ asset('storage/icons/logoif.ico.png') }}" type="" />
    ...
    <nav class="navbar navbar-expand-xl nav-color">
                                ...
                                <div class="card-body">
                                    <form method="post" id="formProject" action="/projects" enctype="multipart/form-data" class="lef form-group">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="title" maxlength="34" class="form-control"> @error('title')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <textarea name="description" class="form-control"></textarea> @error('description')
                                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span> @enderror
                                            </div>
        ...
        <script type="text/javascript">
                ...
                $('#file').change((event)=>{
                    ...
                    var num = archives.val().length

                    var newnovo = num - 4
                    var newout = num - 5
                    var fileo = archives.val().toLowerCase().slice(newout, num)
                    var file =  archives.val().toLowerCase().slice(newnovo, num)
                    var ele = document.querySelector("#type-file")

                    if(file == ".mp4"){
                        ele.innerHTML = icons('fas fa-video')
                    }else if(file == ".png" || file == ".jpg" || fileo == ".jpeg" || file == ".gif"){
                        ele.innerHTML = icons('fas fa-image')
                    }else if(file == ".zip"){
                        ele.innerHTML = icons('fa fa-code')
                    }else if (file == "" || fileo == ""){

                    }else{
                        alert("archive not find")
                    }
                })
